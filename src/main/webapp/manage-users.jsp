...
<html lang="en">
<head>
    <title>Manage Users | City Cab Service</title>
...
<header class="bg-white shadow">
    <div class="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        <ul class="flex gap-6 text-sm font-medium">
            ...
            <li><a href="manage-users.jsp" class="text-blue-600 border-b-2 border-blue-600">Users</a></li>
...
<main class="container mx-auto px-6 py-10">
    <section class="mb-10">
        ...
        <p class="text-gray-600">Showing user details from users.txt</p>
    </section>
    ...
    <section class="overflow-x-auto bg-white rounded-xl shadow-lg p-6">
        <table class="min-w-full table-auto">
            ...
            <tr class="border-b hover:bg-blue-50">
                ...
                <td class="px-4 py-2">
                    <a href="edit-user.jsp?id=<%= parts[0] %>" class="text-blue-600 hover:underline">Edit</a>
                </td>
                <td class="px-4 py-2">
                    <a href="delete-user.jsp?id=<%= parts[0] %>"
